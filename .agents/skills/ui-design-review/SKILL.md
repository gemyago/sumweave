...
credits: https://github.com/jezweb/claude-skills/blob/main/plugins/frontend/skills/design-review/SKILL.md
---
...
Write findings to `tmp/ui-design-review/<timestamp>-<slug>/summary.md`:
...
Take screenshots of findings where the issue is visual (most of them) and save to the `tmp/ui-design-review/<timestamp>-<slug>` dir.
