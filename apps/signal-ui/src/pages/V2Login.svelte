...
<section class="container py-5" aria-labelledby="v2-login-heading">
  <div class="row justify-content-center">
    <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
      <div class="card shadow-sm border-0">
        <div class="card-body p-4 p-lg-5">
          <h1 id="v2-login-heading" class="h3 mb-3">Sign in</h1>

          <form class="d-grid gap-3" onsubmit={(event) => form.submit(event)}>
            <div>
              <label class="form-label" for="v2-login-username">Username</label>
              <input
            ...
            <div>
              <label class="form-label" for="v2-login-password">Password</label>
              <input
