...
describe('Admin finance providers page', () => {
  beforeEach(() => {
    ...
    jobsMocks.listJobs.mockResolvedValue({ items: [{ id: 'job-1', jobType: 'finance.bank_connection_sync', status: 'failed', requester: { userId: 'user-1', source: 'operator', agentSessionId: '', agentRunId: '' }, input: { ingestionRunId: '', venue: '', symbol: '', assetClass: '', timeframe: '', start: new Date('2026-06-20T12:00:00Z'), end: new Date('2026-06-20T12:00:00Z'), pageSize: 0 }, createdAt: new Date('2026-06-20T12:00:00Z'), updatedAt: new Date('2026-06-20T12:00:00Z'), startedAt: null, completedAt: null, attemptCount: 1 }], nextCursor: '' })
  })
