...
func NewFinanceCashFlowSeriesPeriodValidator() FieldValidator[*FinanceCashFlowSeriesPeriod] {
	...
	return func(bindingCtx *BindingContext, value *FinanceCashFlowSeriesPeriod) {
