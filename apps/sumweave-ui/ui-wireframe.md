...
- Body order:
  ...
  - second row: full-width paged **Transactions** list scoped to the selected reporting range. **View all transactions** carries that same inclusive range into the ledger.
