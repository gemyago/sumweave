export interface ClassificationDateRange {
  startDate: string
  endDate: string
}

export interface ClassificationRequestRange extends ClassificationDateRange {
  rangeStart: string
  rangeEndExclusive: string
}

export function defaultClassificationDateRange(now = new Date()): ClassificationDateRange {
...
export function classificationRangeFromDateInputs(startDate: string, endDate: string): ClassificationRequestRange {
