...
export interface JobDetail extends JobSummary { lastAttemptAt?: Date | null }
...
interface RawJobDetail extends RawJobSummary { lastAttemptAt?: string | null }
...
function mapJobDetail(raw: RawJobDetail): JobDetail { return { ...mapJobSummary(raw), lastAttemptAt: parseOptionalTimestamp(raw.lastAttemptAt, 'jobs.job.lastAttemptAt') } }
