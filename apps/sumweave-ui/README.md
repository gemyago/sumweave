...
Web front end for Sumweave: a **Svelte 5** + **TypeScript** single-page app built with **Vite**. You edit sources here; `vite build` produces a static **`dist/`** you can host anywhere.
...
From this folder (`apps/sumweave-ui`):
