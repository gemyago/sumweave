...
- **WHEN** a developer inspects the `signal-foundry` command tree
...
- **WHEN** a developer runs `signal-foundry start-all` after the documented schema preparation step
...
- **WHEN** a user runs `signal-foundry start`
