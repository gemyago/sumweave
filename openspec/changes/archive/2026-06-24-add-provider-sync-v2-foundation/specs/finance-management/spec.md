...
- **AND** it MUST keep last attempt, last success, last successful window, last run or job identity, last error summary, and aggregate sync stats where available
