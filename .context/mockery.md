...
* It's configured via mockery config `.mockery.yaml` file. Search in a module root.
* If you need to regenerate mocks, always run `go run github.com/vektra/mockery/v3` from module root without args
